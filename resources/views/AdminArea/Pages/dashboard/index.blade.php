                                        ...
                                        <div
                                            ...
                                            <div class="nk-sale-data-group flex-md-nowrap g-4">
                                                <div class="nk-sale-data">
                                                    <span class="amount">14,299.59 LKR</span>
                                        ...
                                        <div class="card card-bordered">
                                            <div class="card-inner">
                                                ...
                                                <div class="align-end flex-sm-wrap g-4 flex-md-nowrap">
                                                    <div class="nk-sale-data">
                                                        <span class="amount">27000 LKR</span>
                                    ...
                                    <div class="col-sm-6 col-lg-12 col-xxl-6">
                                        <div class="card card-bordered">
                                            <div class="card-inner">
                                                <div class="card-title-group align-start mb-2">
                                                    <div class="card-title">
                                                        <h6 class="title">Today Income</h6>
                                                    </div>
                                                    <div class="card-tools">
                                                        <em class="card-hint icon ni ni-help-fill" data-toggle="tooltip"
                                                ...
                                                <div class="align-end flex-sm-wrap g-4 flex-md-nowrap">
                                                    <div class="nk-sale-data">
                                                        <span class="amount">100000 LKR</span>
                                ...
                                <div class="card card-bordered h-100">
                                    <div class="card-inner">
                                            ...
                                            <div class="card-tools">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="date" class="form-control" id="default-01" placeholder="Enter Date ranage">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="nk-sale-data-group align-center justify-between gy-3 gx-5">
                                            <div class="nk-sale-data">
                                                <span class="amount">82,944.60 LKR</span>
                                            </div>
