        ...
        <div class="nk-header-wrap">
            ...
            <div class="nk-header-tools">
                ...
                <ul class="nk-quick-nav">
                    <a href="#" class="btn btn-primary btn-sm btn-round "><em class="icon ni ni-repeat"></em><span>Cashier Mode</span> </a>
                    ...
                    <li class="dropdown user-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                            ...
                            <div class="dropdown-inner">
                                <ul class="link-list">
                                    <li><a href="javascript:void(0)" data-toggle="modal" data-target="#logoutModal"><em class="icon ni ni-signout"></em><span>Sign out</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </li>
